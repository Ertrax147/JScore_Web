package com.example.demo.service.resetpassword;

import com.example.demo.model.user.Club;
import com.example.demo.model.user.PasswordResetTokenClub;
import com.example.demo.repository.ClubRepository;
import com.example.demo.repository.PasswordResetTokenClubRepository;
...
public class PasswordResetClubService {
    ...
    private com.example.demo.service.resetpassword.CorreoService correoService;

    public PasswordResetClubService(ClubRepository clubRepo, PasswordResetTokenClubRepository tokenRepo,
                                    com.example.demo.service.resetpassword.CorreoService correoService) {
